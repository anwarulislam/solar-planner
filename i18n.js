...
const TRANSLATIONS = {
  en: {
    ...
    sectionSolar: "Solar Panel",
    sectionBattery: "Battery",
    sectionInverter: "Inverter & Controller",
    panelWatts: "Panel Size",
    panelWattsHint: "Rated wattage per individual panel",
    enableSolar: "Enable Solar Panels",
    enabled: "Enabled",
    disabled: "Disabled",
    solarToggleHint: "Turn off if you only want grid charging",
  ...
  bn: {
    ...
    sectionSolar: "সোলার প্যানেল",
    sectionBattery: "ব্যাটারি",
    sectionInverter: "ইনভার্টার ও কন্ট্রোলার",
    panelWatts: "প্যানেলের আকার",
    panelWattsHint: "প্রতিটি প্যানেলের রেটেড ওয়াটেজ",
    enableSolar: "সোলার প্যানেল",
    enabled: "চালু",
    disabled: "বন্ধ",
    solarToggleHint: "শুধুমাত্র গ্রিড চার্জিং চাইলে বন্ধ করুন",
